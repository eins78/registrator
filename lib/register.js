...
exports.attach = function (options) {
  ...
  var leaseTimedOut = function (knoten, network) {
    ...
    console.log("networkLease",networkLease)
    console.log("knotenLease",knotenLease)
  ...
  deleteKnoten = function (knoten, network, callback) {
    ...
    console.log("delete knoten: ", knoten)
    ...
    Knoten.destroy(knoten.id, function (err, result) {
      ...
      // - fail on db error or deletion error
      //     > "status" should be the only property on `result`,
      ...
      if (err || result.status !== 204) {
        ...
        console.log(network.id + ": could not delete: "+knoten.id+"! ("+err+")");
      }
